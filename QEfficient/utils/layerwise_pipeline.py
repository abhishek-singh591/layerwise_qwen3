...
def _window_paths(exported_path: str, layer_start: int, layer_end: int) -> Tuple[str, str, str]:
    ...
    onnx_tmp = f"{base_dir}/Qwen3MoeForCausalLM_layer_tmp_{layer_start}_{layer_end}.onnx"
...
def split_layer_graph(
    ...
    cache_inputs = sorted([n for n in graph_inputs if n.startswith("past_key.") or n.startswith("past_value.")])
